import { component$, type FunctionComponent, useVisibleTask$, useStore } from "@builder.io/qwik";
...
export default component$(() => {
  ...
  return (
    <>
      ...
      >
        {Array.from({ length: state.number }, (_, i) => <Square key={i} class={{ [odd]: i % 2 === 0 }} style={{ "--index": `${i + 1}` }} />).reverse()}
      </Host>
    </>
  );
});
